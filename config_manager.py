...
def _default_config():
    return {
        "gestures": {
            "fist":      {"label": "Fist",          "emoji": "\u270a",     "fingers": "0 fingers", "action": "play_pause", "description": "Play / Pause Toggle"},
            "index_up":  {"label": "One Finger",    "emoji": "\u261d\ufe0f", "fingers": "1 finger",  "action": "skip_bwd",   "description": "Skip Backward 10s"},
            "peace":     {"label": "Two Fingers",   "emoji": "\u270c\ufe0f", "fingers": "2 fingers", "action": "speed_2x",   "description": "Speed 2x (hold)"},
            "three_up":  {"label": "Three Fingers", "emoji": "\ud83e\udd1f", "fingers": "3 fingers", "action": "skip_fwd",   "description": "Skip Forward 10s"},
            "open_palm": {"label": "Open Palm",     "emoji": "\u270b",     "fingers": "4 fingers", "action": "mute",       "description": "Mute / Unmute"},
        },
        "available_actions": {
            "play_pause":  {"label": "Play / Pause Toggle",  "keys": ["space"]},
        ...
        "settings": {
            ...
            "target_windows":        ["youtube", "vlc", "media player", "netflix", "spotify"],
        },
    }
